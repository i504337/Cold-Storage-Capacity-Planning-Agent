# Cold Storage Capacity Agent

An AI agent for cold storage capacity planning in SAP EWM — answers natural language queries about temperature-controlled storage availability, projects time-phased capacity over a 1-2 week horizon, and raises breach alerts when incoming orders exceed available storage
